	...
	return (
		<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
			...
			<div>
				...
				{loadingSlots ? (
					<div className="w-full rounded-lg border border-gray-200 px-4 py-2 text-gray-200 text-sm">
					...
					<select
						...
						disabled={!date}
						className="w-full rounded-lg border border-gray-200 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
					>
